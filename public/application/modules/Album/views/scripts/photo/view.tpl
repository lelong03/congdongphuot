...
<?php
    ...
    $this->headMeta()->appendName('og:image', $this->serverName . $this->baseUrl() . $this->photo->getPhotoUrl());
    $this->headMeta()->appendName('og:url', $this->serverName . $this->baseUrl() . $this->photo->getHref());
...
<?php
    ...
    $this->headMeta()->appendName('image', $this->serverName . $this->baseUrl() . $this->photo->getPhotoUrl());
?>
<?php
    $this->headMeta()->appendName('twitter:card', 'summary');
    $this->headMeta()->appendName('twitter:site', $this->serverName . $this->baseUrl() . $this->photo->getHref());
    $this->headMeta()->appendName('twitter:title', $this->album->getTitle());
    $this->headMeta()->appendName('twitter:description', $albumDes);
    $this->headMeta()->appendName('twitter:image:src', $this->serverName . $this->baseUrl() . $this->photo->getPhotoUrl());
