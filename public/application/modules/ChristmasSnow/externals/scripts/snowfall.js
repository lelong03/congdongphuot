...
var snowStorm = (function(window, document) {
  ...
  this.animationInterval = snowOptions['speed'];    // Theoretical "miliseconds per frame" measurement. 20 = fast + smooth, but high CPU use. 50 = more conservative, but slower
  this.excludeMobile = true;      // Snow is likely to be bad news for mobile phones' CPUs (and batteries.) By default, be nice.
  this.flakeBottom = null;        // Integer for Y axis snow limit, 0 or null for "full-screen" snow effect
  this.followMouse = true;        // Snow movement can respond to the user's mouse
  this.snowColor = snowOptions.color;        // Don't eat (or use?) yellow snow.
  this.snowCharacter = snowOptions.char;  // &bull; = bullet, &middot; is square on some systems etc.
