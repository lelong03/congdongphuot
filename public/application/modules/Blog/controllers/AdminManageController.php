...
class Blog_AdminManageController extends Core_Controller_Action_Admin
{
  public function indexAction()
  {
    ...
    $categoryTbl = Engine_Api::_()->getItemTable('blog_category');
    $categories = $categoryTbl -> fetchAll();
    $cateArr =  array();
    foreach ($categories as $category)
    {
        $cateArr[$category->category_id] = $category -> category_name;
    }
  ...
  public function featuredAction()
  {
    ...
    $featured_value = $this->_getParam('featured_value', null);
    if( $this->getRequest()->isPost())
    {
      $db = Engine_Db_Table::getDefaultAdapter();
      $db->beginTransaction();
