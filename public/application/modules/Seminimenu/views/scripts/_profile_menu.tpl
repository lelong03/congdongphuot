...
{				
  	echo $this->htmlLink($this->viewer()->getHref(), '<div>'.$img.'</div>'.strip_tags($this->string()->truncate($this->viewer()->getTitle(), 20)),array('class'=> 'menu_core_mini core_mini_profile'));				 
}
?>      