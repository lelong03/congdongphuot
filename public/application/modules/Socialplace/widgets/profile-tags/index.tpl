	...
	foreach($this->tags as $tag):
		...
		if(trim($tag->text) != ""):
			...
			<span style="<?php if($tagCounter > 99 && $tagCounter < 599): echo "font-size:".($tagCounter/80 + 8)."pt"; elseif($tagCounter > 599): echo "font-size: 14pt"; endif; ?>">            
				<a href="javascript:;" onclick="javascript:tagAction(<?php echo $tag->tag_id; ?>);" title="<?php echo $this->translate(array("%s place", "%s places", $tagCounter), $this->locale()->toNumber($tagCounter));?>">
					<?php echo $tag->text?>
