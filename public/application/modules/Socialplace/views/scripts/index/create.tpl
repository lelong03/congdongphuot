...
<?php else: ?>
  <?php 
    ...
    $adminText = $this->htmlLink($admin->getHref(),
                  $this->string()->truncate($admin->getTitle(), 10),
                  array('target' => '_blank'));
  ?>
  <?php echo $this->translate("Please send message to admin %1s or email to %2s", $adminText, 'congdongphuot@gmail.com'); ?>
<?php endif; ?>
