...
<h2>
  ...
  <?php echo $this->htmlLink(array(
          ...
          'controller' => 'photo',
          'action' => 'list',
          'subject' => $this->place->getGuid(),
      ), $this->translate('Photos')) ?>
</h2>

<div class='layout_middle'>
<div class='socialplace_photo_view'>
  <div class="socialplace_photo_nav">
    <div>
  ...
  <div class='socialplace_photo_info'>
    <div class='socialplace_photo_container' id='media_photo_div'>
    ...
    <div class="socialplace_photo_date">
      ...
      <?php if( $this->canEdit): ?>
        ...
        - <?php echo $this->htmlLink(array('route' => 'socialplace_extended', 'controller' => 'photo', 'action' => 'edit', 'photo_id' => $this->photo->getIdentity(), 'format' => 'smoothbox'), $this->translate('Edit'), array('class' => 'smoothbox')) ?>
        - <?php echo $this->htmlLink(array('route' => 'socialplace_extended', 'controller' => 'photo', 'action' => 'delete', 'photo_id' => $this->photo->getIdentity(), 'format' => 'smoothbox'), $this->translate('Delete'), array('class' => 'smoothbox')) ?>
      <?php endif; ?>
  ...
  <?php echo $this->action("list", "comment", "core", array("type"=>"socialplace_photo", "id"=>$this->photo->getIdentity())); ?>
</div>
</div>