...
<script type="text/javascript">
	...
	function initialize() {
		var mapOptions = {
	  	...
	  	map = new google.maps.Map(document.getElementById('socialplace-items-map-canvas'),mapOptions);
...
<div id="socialplace-items-map-canvas" style="width: 100%; height: 500px;"></div>
<?php else:?>
	<div class="tip">
        <span>
            <?php echo $this->translate("There are no place view on this map") ?>
        </span>
    </div>
<?php endif;?>