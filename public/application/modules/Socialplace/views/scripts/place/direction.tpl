<?php if (!$this->place->longitude || !$this->place->latitude) : ?>
...
<h2>
    <?php echo $this->place->__toString(); ?>
</h2>

<div id="socialplace_direction">
<h4><?php echo $this->translate("Get Direction");?></h4>
<div class="socialplace_widget_location_direction">
    ...
    <span class="close-btn" id="socialplace_location_direction_close_btn">x</span>
    <div class="get_current_position">
        <a href="javascript:void(0);" onclick="getCurrentPosition()" class="buttonlink socialplace-place-item-map-green"><?php echo $this->translate("Get current position");?></a>
    </div>
</div>


<div class="socialplace_widget_location_direction socialplace_widget_location_destination">
	<img src="application/modules/Socialplace/externals/images/map-view.png" />
	<span><?php echo $this->place->location;?></span>
</div>
<div class="socialplace_widget_location_direction socialplace_widget_location_direction_button">
...
<script>
var fromPoint;
var endPoint = new  google.maps.LatLng(<?php echo $this->place->latitude;?>, <?php echo $this->place->longitude;?>);
	...
	if(navigator.geolocation) {
	    navigator.geolocation.getCurrentPosition(function(position) {
			...
			current_posstion = new Request.JSON({
				'format' : 'json',
				'url' : '<?php echo $this->url(array('action'=>'get-my-location'), 'socialplace_general') ?>',
				'data' : {
...
function initialize() {
  var center =  new google.maps.LatLng(<?php echo $this->place->latitude;?>, <?php echo $this->place->longitude;?>);
  var mapOptions = {
    center: center,
    zoom: 13
  };
...
{
	$('socialplace_location_direction_close_btn').addEvent('click', function(e) {
		$('pac-input').set('value','');
		fromPoint = null;
    });
});
