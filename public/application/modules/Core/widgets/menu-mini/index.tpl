...
<div id='core_menu_mini_menu' style="background: #007457;">
  <a href="http://congdongphuot.com/">
    <img style="margin-left: 10px; margin-top: 2px;" skinpart="image" class="logo_simple" alt="" src="<?php echo $this->baseUrl();?>/application/themes/grid-green/images/congdongphuot/logo36.png" />
  </a>
  <?php
